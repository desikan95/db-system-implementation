...
public:
	...
	//Based on Type and Total Sum of that Type
	//*new function *//
	void ComposeRecord (Type type, int intSumTotal, double doubleSumTotal);
	...
	int GetSize();
        ...
        // prints the contents of the record to the file
        void WriteToFile (FILE *myFile, Schema *mySchema);
};
